...
greating = "<H1>Hej " + setup.get('customer_name') + "</H1><b>Dette er en LUFTFUGTIGHEDS-ALARM fra "+ setup.get('title')+ "  </b>"
...
msgRoot['Subject'] = "LUFTFUGTIGHEDS-ALARM fra " + setup.get('subj_title') + ". " + date 
...
today = datetime.datetime.now().strftime("%d%m%Y-%H%M%S") + setup.get('id') + "H"
...
fp = open('/home/pi/winecellar/img/trendingHumid.png', 'rb')
