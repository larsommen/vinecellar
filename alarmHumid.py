...
greating = "<H1>Hej " + setup.get('customer_name') + "</H1><b>Dette er en LUFTFUGTIGHEDS-ALARM fra din vink&aelig;lder  </b>"
...
msgRoot['Subject'] = "LUFTFUGTIGHEDS-ALARM fra din vinkælder." + " " + date 
